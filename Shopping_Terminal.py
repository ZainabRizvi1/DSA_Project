...
def inventory():
    data=  [
        {"id": 1001, "Info":"1001    Chocolate Cupcake         Price   "+str(120),"Name":"Chocolate Cupcake","Price":120,"Stock":20},
        {"id": 1002, "Info":"1002    Butterscotch Cupcake      Price   "+str(120),"Name":"Butterscotch Cupcake","Price":120,"Stock":20},
        {"id": 1003, "Info":"1003    Red Velvet Cupcake        Price   "+str(120),"Name":"Red Velvet Cupcake","Price":120,"Stock":20},
        {"id": 1004, "Info":"1004    Hershey's Brownie         Price   "+str(80),"Name":"Hershey's Brownie","Price":80,"Stock":20},
        {"id": 1005, "Info":"1005    Fudge Brownie             Price   "+str(100),"Name":"Fudge Brownie","Price":100,"Stock":20},
        {"id": 1006, "Info":"1006    Oreo Shake                Price   "+str(499),"Name":"Oreo Shake","Price":499,"Stock":20},
        {"id": 1007, "Info":"1007    Vanilla Almond Milk       Price   "+str(499),"Name":"Vanilla Almond Milk","Price":499,"Stock":20},
        {"id": 1008, "Info":"1008    Raspberry Cupcake         Price   "+str(120),"Name":"Raspberry Cupcake","Price":120,"Stock":20},
        {"id": 1009, "Info":"1009    Lotus Brownie             Price   "+str(100),"Name":"Lotus Brownie","Price":100,"Stock":20}
        ]
    return data
def userMenu(x):
    for each in x:
